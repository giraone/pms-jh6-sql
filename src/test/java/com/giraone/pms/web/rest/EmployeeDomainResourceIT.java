...
class EmployeeDomainResourceIT {
    ...
    void getAllEmployeesAsUser() throws Exception {
    ...
    @Transactional
    @WithMockUser(username = "admin", roles = "ADMIN")
    void getEmployeeAsAdmin() throws Exception {
    ...
    @Transactional
    @WithMockUser(username = TEST_USER, roles = "USER")
    void getEmployeeAsUser() throws Exception {
