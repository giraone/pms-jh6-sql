...
class EmployeeRepositoryIT {
    ...
    @Test
    void whenSavingEntity_checkThatMultipleNamesAreStoredForMultipleNames() {
    ...
    @Test
    void deleteEmployee_deletesNamesAlso() {
    ...
    @Test
    void deleteAllEmployees_deletesNamesAlso() {
    ...
    @Test
    void findAllBySurname_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllBySurnameAndGivenName_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllBySurnameAndDateOfBirth_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllBySurnameAndGivenNameAndDateOfBirth_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllByCompany_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllByCompanyAndSurname_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllByCompanyAndSurnameAndDateOfBirth_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllByKeyPaemployeeirLike_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllByDateOfBirthAndKeyPairLike_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllByCompanyAndKeyPairLike_withExistingEmployee_returnsEmployee() {
    ...
    @Test
    void findAllByCompanyAndDateOfBirthAndKeyPairLike_withExistingEmployee_returnsEmployee() {
