...
class PersonFilterTest {
    ...
    @Test
    void buildFromInput_singleExactNameOnly() {
    ...
    @Test
    void buildFromInput_singleWeakMatchingNameOnly() {
    ...
    @Test
    void buildFromInput_twoExactNamesWithComma() {
    ...
    @Test
    void buildFromInput_twoWeakNamesWithComma() {
    ...
    @Test
    void buildFromInput_dateAndSingleName() {
    ...
    @Test
    void buildFromInput_SurnamesAndGivenNamesWithComma() {
    ...
    @Test
    void buildFromInput_dateAndTwoSurnames() {
